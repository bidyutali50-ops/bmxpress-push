...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-all duration-300 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        primary:
          "bg-primary text-white shadow-[0_0_0_1px_rgba(227,6,19,0.4),0_8px_30px_-6px_rgba(227,6,19,0.55)] hover:shadow-[0_0_0_1px_rgba(227,6,19,0.6),0_12px_40px_-6px_rgba(227,6,19,0.75)] hover:-translate-y-0.5",
        outline:
